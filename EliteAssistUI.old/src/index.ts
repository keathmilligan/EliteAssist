import { app, BrowserWindow, Tray, Menu, nativeImage, MenuItem, MenuItemConstructorOptions, ipcMain } from 'electron';
...
function buildMenu(): void {
  ...
  const contextMenu = Menu.buildFromTemplate([
    { label: 'New Dashboard', click:  newDashboard},
    { type: 'separator' },
